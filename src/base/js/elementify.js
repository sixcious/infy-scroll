    ...
    elements = new Map(
      [...elements].filter(function ([k,v]) {
        ...
        try {
          ...
          // Note 2: Found the reason, it was due to using currentDocument (which is not on the page), so we don't have getBCR. So the solution is to just always pass in regular document
